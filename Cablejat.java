...
public class Cablejat {
    ...
    public static class CableUSB {
        ...
        public boolean esPotConnectar() {
            // Crear un set para almacenar los extremos de los cables
            ...
            for (String connector : connectors) {
                ...
                // Verificar si los extremos están en el set
            ...
            // Si el set está vacío, se puede formar un círculo con todos los cables
